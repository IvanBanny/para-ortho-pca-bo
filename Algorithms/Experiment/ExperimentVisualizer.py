...
class ExperimentVisualizer:
    ...
    def plot_convergence(self):
        ...
        for d_idx, dimension in enumerate(dimensions):
            ...
            for f_idx, function in enumerate(functions):
                ...
                self._plot_individual_convergence(dimension, function, ax)
        ...
        if self.save_figures:
            plt.savefig(os.path.join(self.output_dir, f"convergence.png"), format="png")

    def _plot_individual_convergence(self, dimension: int, function: int, ax: plt.Axes):
    ...
    def plot_times(self):
        ...
        for d_idx, dimension in enumerate(dimensions):
            ...
            self._plot_individual_times(dimension, ax)
            ...
            if self.save_figures:
                plt.savefig(os.path.join(self.output_dir, f"times.png"), format="png")

    def _plot_individual_times(self,  dimension: int, ax: plt.Axes):
        """Plot convergence graph for a specific axis.
        ...
        df = (
            ...
            .select(["algorithm_name", "dimension", "function_id", "time"])
        ...
        for i, algorithm in enumerate(algorithms):
            ax.boxplot(
                ...
                boxprops=dict(facecolor=self.colors[i], alpha=0.85),
